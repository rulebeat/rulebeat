...
describe('migrateDashboardConfig', () => {
  it('rewrites a legacy top-policies widget to top-rules, config unchanged', () => {
  ...
  it('rewrites a legacy policies-scanned stat metric to rules-scanned', () => {
  ...
  it('is idempotent — a config with nothing to migrate passes through unchanged', () => {
  ...
  it('leaves widgets untouched by any mapping as-is', () => {
