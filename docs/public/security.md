...
```bash
docker buildx imagetools inspect ghcr.io/rulebeat/rulebeat:0.2.3 --format '{{ json .SBOM }}'
docker buildx imagetools inspect ghcr.io/rulebeat/rulebeat:0.2.3 --format '{{ json .Provenance }}'
```
